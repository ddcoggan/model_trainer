...
adding stochastic depth to v22 to see if performance / speed improves
"""
...
class FLaBBlock(nn.Module):
    ...
    def __init__(self, channels, norm_groups, kernel_size=3, stride=2,
                 cardinality=32, lat_pad=1, back_pad=3, back=True, sd_prob=.2):
        super().__init__()
