...
Alternative to v18. Maxpooling is kept but V4 becomes V3, 
IT becomes V4 and a new IT block is added.
"""
...
class CogNet(nn.Module):
    ...
    def __init__(self, cycles=5):
        ...
        self.V4 = CogBlock(channels=chn[3:6], lat_pad=0, back_pad=1)
        self.IT = CogBlock(channels=chn[4:7], back_pad=2)
