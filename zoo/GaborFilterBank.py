...
if __name__ == "__main__":
    ...
    GFB = GaborFilterBank(
        canvas_size=(224,224),  # width x height
        center_range=(0,224,0,224),  # [x_start, x_end, y_start, y_end]
        sizes=(1),  # +/- 2 SD of envelope
        spatial_frequencies=(1,2,4,8),  # cycles / envelop SD
        contrasts=(1,),
        orientations=8,
        phases=8,
        aspect_ratios=(1,2,4),
