...
class COGV1(nn.Module):
    ...
    def __init__(self, kernel_size=7, stride=2, image_size=224, num_scales=7,
        ...
        self.conv = nn.Conv2d(3, 64, kernel_size=kernel_size,
    ...
    def forward(self, inp):
        ...
        out = torch.zeros(inp.shape[0], 64, self.output_size, self.output_size,
