...
M = SimpleNamespace(
    ...
    architecture = 'cornet_s',  # used to load architecture and name of top-level results directory
    ...
    identifier = 'test',  # name of second-level results directory
...
O = SimpleNamespace(
    ...
    scheduler = 'StepLR',#'ReduceLROnPlateau',#StepLR',  # any attribute of torch.optim.lr_scheduler
    scheduler_args = dict(
        #patience = 8,
        gamma=0.1,
        step_size = 30,
