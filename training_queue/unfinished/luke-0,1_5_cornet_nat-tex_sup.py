...
M = SimpleNamespace(
    ...
    model_dir = op.expanduser(f'~/david/models/cornet_s_plus/occ-nat1-tex-weak_xform_cont'), #None, # manual override for results directory
...
D.Occlusion = SimpleNamespace(
    form = 'naturalTexturedCropped1',       # occluder type or list thereof
...
O = SimpleNamespace(
    ...
    primary_metric = 'acc1',  # metric to guide "best" params and lr scheduler
