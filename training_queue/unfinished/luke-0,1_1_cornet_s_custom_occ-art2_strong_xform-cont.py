...
M = SimpleNamespace(
    ...
    identifier = 'hd-2_hw-3_V1f-128_occ-art2-strong_xform-cont',  # used to name model directory, required
...
D.Occlusion = SimpleNamespace(
    type = ['noise_coarse', 'noise_fine', 'noise_fine-ori', 'noise_pink'],                    # occluder type or list thereof
