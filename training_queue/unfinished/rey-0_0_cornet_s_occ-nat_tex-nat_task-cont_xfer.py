...
M = SimpleNamespace(
    ...
    model_name = 'cornet_s',
    identifier = 'occ-nat',
    model_dir = op.expanduser('~/david/projects/p022_occlusion/in_silico/models/cornet_s/occ-nat_tex-nat_vis-beh_task-cont'),
...
D = SimpleNamespace(
    ...
    #views_altered = [1],  # views to apply alterations to
