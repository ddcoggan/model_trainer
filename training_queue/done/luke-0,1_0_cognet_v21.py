...
M = SimpleNamespace(
    ...
    architecture = 'cognet_v21',  # used to load architecture and name of top-level results directory
    ...
    model_dir = op.expanduser(f'~/david/models/cognet/v21'), #None, # manual override for results directory
