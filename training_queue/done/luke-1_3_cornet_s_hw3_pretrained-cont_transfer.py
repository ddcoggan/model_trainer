...
M = SimpleNamespace(
    ...
    identifier = 'pretrained-cont_encoder',  # used to name model directory, required
    save_interval = 4,  # preserve params at every n epochs
    transfer = True,
    transfer_dir = 'transfer_pretrained',
    freeze_layers = ['V1','V2','V4','IT'],
    starting_params = '/home/tonglab/david/projects/p022_occlusion/in_silico/models/cornet_s/task-cont/params/043.pt',
)
"""
