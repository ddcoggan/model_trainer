...
M = SimpleNamespace(
    ...
    architecture = 'cognet_v22',  # used to load architecture and name of top-level results directory
    ...
    model_dir = op.expanduser(f'~/david/models/cognet/v22_natural_occluders'), #None, # manual override for results directory
...
D.Occlusion = SimpleNamespace(
    form = 'naturalTexturedCropped',       # occluder type or list thereof
...
O = SimpleNamespace(
    ...
    scheduler_args = dict(
        ...
        patience = 8, factor = .1, mode = 'max', # ReduceLROnPlateau
    ),
