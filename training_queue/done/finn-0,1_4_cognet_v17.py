...
M = SimpleNamespace(
    ...
    architecture = 'cognet_v17',  # used to load architecture and name of top-level results directory
    ...
    model_dir = op.expanduser(f'~/david/models/cognet/v17'), #None, # manual override for results directory
