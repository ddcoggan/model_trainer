...
# model
M = SimpleNamespace(
    model_name = 'cornet_rt_hw3',
    identifier = 'occ-beh_vis-beh_xform-cont',  # used to name model directory, required
...
D.Occlusion = SimpleNamespace(
    type = occluders_behavioural, #'naturalTexturedCropped', #occluders_behavioural,                     # occluder type or list thereof
