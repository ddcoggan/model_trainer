...
M = SimpleNamespace(
    ...
    architecture = 'cognet_v20',  # used to load architecture and name of top-level results directory
    ...
    model_dir = op.expanduser(f'~/david/models/cognet/v20'), #None, # manual override for results directory
...
O = SimpleNamespace(
    ...
    scheduler_args = dict(
        ...
        patience = 10, factor = .1,  # ReduceLROnPlateau
    ),
