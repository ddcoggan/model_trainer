...
M = SimpleNamespace(
    ...
    identifier = 'pretrained_encoder',  # used to name model directory, required
    save_interval = 4,  # preserve params at every n epochs
    transfer = True,
    transfer_dir = 'transfer_pretrained_task-cont',
    ...
    starting_params = '/home/tonglab/david/repos/CORnet-master/cornet/cornet_s-1d3f7974.pth',
)
"""
