...
M = SimpleNamespace(
    ...
    architecture = 'cognet_v14',  # used to load architecture and name of top-level results directory
    ...
    model_dir = op.expanduser(f'~/david/models/cognet/v14'), # results directory
