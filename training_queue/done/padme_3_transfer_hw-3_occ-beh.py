...
M = SimpleNamespace(
    ...
    identifier = 'head-depth-2_head-width-3_V1-feat-128_occ-beh_task-cont',  # used to name model directory, required
    save_interval = 4,  # preserve params at every n epochs
    transfer = True,
    transfer_dir = 'transfer_unocc',
    freeze_layers = ['V1','V2','V4','IT'],  # freeze params up to this index (for transfer learning) cornet_s = 84
